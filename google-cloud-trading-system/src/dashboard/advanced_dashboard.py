...
@app.route('/mockup')
def mockup():
    """Performance & Roadmap Dashboard Mockup"""
    mockup_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), 'dashboard_mockup_performance_roadmap.html')
