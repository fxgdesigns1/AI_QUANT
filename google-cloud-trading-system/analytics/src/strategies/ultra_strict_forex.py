...
class UltraStrictForexStrategy:
    ...
    def __init__(self):
        ...
        # Strategy parameters - OPTIMIZED FOR HIGH-QUALITY GUARANTEED TRADES
        ...
        self.min_signal_strength = 0.65  # HIGH CONFIDENCE - guaranteed trades only
        self.max_trades_per_day = 30  # QUALITY over quantity
    ...
    def _generate_trade_signals(self, market_data: Dict[str, MarketData]) -> List[TradeSignal]:
        ...
        for instrument in self.instruments:
            ...
            # LOOSENED: Allow BUY with just EMA signal OR with both EMA + momentum
            ...
            # LOOSENED: Allow SELL with just EMA signal OR with both EMA + momentum
