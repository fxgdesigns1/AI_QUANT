#!/usr/bin/env python3
"""
ICT OTE Strategy Standalone Optimizer
Complete optimization system with backtesting and Monte Carlo simulation
No dependencies on existing codebase structure
"""
...
class ICTOTEStandaloneOptimizer:
    """Standalone ICT OTE Strategy Optimizer"""
    
    def __init__(self, config: OptimizationConfig):
        self.config = config
        self.api_key = os.environ.get('OANDA_API_KEY', 'c01de9eb4d793c945ea0fcbb0620cc4e-d0c62eb93ed53e8db5a709089460794a')
        ...
        logger.info("🚀 ICT OTE Standalone Optimizer initialized")
            ...
            for instrument, df in historical_data.items():
                ...
                for timestamp, row in df.iterrows():
                    ...
                    for signal in signals:
                        ...
                        exit_price = entry_price * (1.001 if signal.side == 'BUY' else 0.999)
    ...
    def save_results(self, filename: str = None) -> str:
        ...
        if not filename:
            ...
            filename = f"ict_ote_standalone_optimization_{timestamp}.json"
...
def main():
    ...
    # Create optimizer
    optimizer = ICTOTEStandaloneOptimizer(config)
